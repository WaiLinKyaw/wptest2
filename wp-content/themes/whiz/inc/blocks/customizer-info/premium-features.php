...
add_action('customize_register', 'whiz_customizer_premium_features');

function whiz_customizer_premium_features($wp_customize)
{
	...
	$premium_features = '<div class="premium-info"><h2>' . esc_html__('Premium Version', 'whiz') . ': </h2>
	...
	<a class="button button-primary" href="' . esc_url('https://graphthemes.com/whiz/') . '" target="_blank">' . esc_html__('Upgrade to Pro', 'whiz') . '</a></div>';

	$wp_customize->add_control(new Whiz_Custom_Text($wp_customize, 'premium_features', array(

...
add_action('customize_register', 'whiz_register_post_detail_customization_section');
function whiz_register_post_detail_customization_section($wp_customize)
{

	$wp_customize->add_section('whiz_post_detail_customization_section', array(
		'title'	=> esc_html__('Post Detail', 'whiz'),
		'priority'	=> 23
	));
}

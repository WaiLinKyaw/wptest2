...
add_action('customize_register', 'whiz_post_detail_featured_image');
function whiz_post_detail_featured_image($wp_customize)
{

    $wp_customize->add_setting('post_detail_hide_show_featured_image', array(
        'sanitize_callback'     =>  'whiz_sanitize_checkbox',
        'default'               =>  whiz_get_default_post_detail_featured_image()
    ));
...
add_action('customize_register', 'whiz_post_detail_featured_image_size');
function whiz_post_detail_featured_image_size($wp_customize)
{

    $wp_customize->add_setting('post_detail_featured_image_size', array(
        'default'     => whiz_get_default_post_detail_featured_image_size(),
    ...
    $wp_customize->add_control('post_detail_featured_image_size', array(
        ...
        'active_callback' => function () {
            return get_theme_mod('post_detail_hide_show_featured_image', whiz_get_default_post_detail_featured_image());
        },
        'choices'     => array(

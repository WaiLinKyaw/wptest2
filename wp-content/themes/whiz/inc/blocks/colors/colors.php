...
add_action( 'customize_register', 'whiz_color_section' );
function whiz_color_section( $wp_customize )
{
    $wp_customize->get_section( 'colors' )->title = esc_html__( "Color Options", 'whiz' );

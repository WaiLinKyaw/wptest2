<script type="text/javascript">
	var fb = '<?php echo esc_html__("Facebook", 'whiz'); ?>';
	var twitter = '<?php echo esc_html__("Twitter", 'whiz'); ?>';
	var pinterest = '<?php echo esc_html__("Pinterest", 'whiz'); ?>';
	var linkedin = '<?php echo esc_html__("Linkedin", 'whiz'); ?>';
</script>
...
<ul class="list-inline">
	...
	<li><?php esc_html_e("Share", 'whiz'); ?>:</li>

...
add_action('customize_register', 'whiz_post_snippet_category');
function whiz_post_snippet_category($wp_customize)
{

    $wp_customize->add_setting('post_snippet_hide_show_category', array(
        'sanitize_callback'     =>  'whiz_sanitize_checkbox',
        'default'               =>  whiz_get_default_post_snippet_category()
    ));
